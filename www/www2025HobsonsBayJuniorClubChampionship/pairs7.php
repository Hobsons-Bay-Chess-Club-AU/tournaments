...
<tr> <td>1</td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td><td class="name"> <span class="idwhite"> 4 </span><span class="notitle male"> </span> <a href="playercard.php#4"> Huang,Michael</a> </td><td>1</td><td class="result"> adj </td><td>0.5</td><td class="name"><span class="idblack">8 </span><span class="notitle male"> </span> <a href="playercard.php#8"> Nema,Nivaan</a></td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td></tr>
<tr> <td>2</td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td><td class="name"> <span class="idwhite"> 5 </span><span class="notitle male"> </span> <a href="playercard.php#5"> Batyrbekov,Aidan</a> </td><td>3</td><td class="result">1 - 0</td><td>1.5</td><td class="name"><span class="idblack">3 </span><span class="notitle male"> </span> <a href="playercard.php#3"> Balaji,Sai Sivesh</a></td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td></tr>
<tr> <td>3</td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td><td class="name"> <span class="idwhite"> 6 </span><span class="notitle male"> </span> <a href="playercard.php#6"> Wei,Andrew</a> </td><td>2.5</td><td class="result"> adj </td><td>2.5</td><td class="name"><span class="idblack">2 </span><span class="notitle male"> </span> <a href="playercard.php#2"> Ashok,Arjun</a></td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td></tr>
<tr> <td>4</td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td><td class="name"> <span class="idwhite"> 7 </span><span class="notitle male"> </span> <a href="playercard.php#7"> Ruaya,Rohan</a> </td><td>2</td><td class="result"> adj </td><td>5</td><td class="name"><span class="idblack">1 </span><span class="notitle male"> </span> <a href="playercard.php#1"> Batyrbekov,Kaisar</a></td><td><img class="shadow" src="flag/aus.png" alt="AUS"></td></tr>
</tbody>
</table>
</DIV><hr>
		  </div>
