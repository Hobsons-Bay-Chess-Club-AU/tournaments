 ...
 <section id="hero" class="d-flex align-items-center">
                <div class="container-fluid">
                    <div class="row items-center">
                        <div class="col-12">
                            <div class="flex flex-column justify-content-center text-center text-white">			<h1 class="mb-3" style="text-shadow: 2px 2px 4px #000000;" >Best in The West</h1>		    <h5 class="mb-1">myTown (AUS)</h5>		    <h5> 31/08/2024 - 01/09/2024</h5>   </div>
 </div> 
 </div>
 </div> 
 </section>
