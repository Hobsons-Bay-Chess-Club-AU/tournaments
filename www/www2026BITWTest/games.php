...
<input type="hidden" id="gamename" value="2026 BITW Test">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2026 BITW Test1.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
