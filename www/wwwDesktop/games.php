...
<input type="hidden" id="gamename" value="Desktop">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/Desktop1.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
