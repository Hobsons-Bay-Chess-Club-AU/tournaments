...
<input type="hidden" id="gamename" value="2025 Hobsons Bay Club Championship">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2025 Hobsons Bay Club Championship2.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
