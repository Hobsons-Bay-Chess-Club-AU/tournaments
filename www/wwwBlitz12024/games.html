...
<input type="hidden" id="gamename" value="Blitz 1 2024">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/Blitz 1 20249.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
