...
<input type="hidden" id="gamename" value="2024 HBCC Hobsons Bay Reserve Championship (1)">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2024 HBCC Hobsons Bay Reserve Championship (1)6.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
