...
<input type="hidden" id="gamename" value="2026 Western Swiss Open">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2026 Western Swiss Open2.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
