...
<tr> <td>1</td><td><img class="shadow" src="flag/os.png" alt="OS"></td><td class="name"> <span class="idwhite"> 6 </span><span class="notitle male"> </span> <a href="playercard.php#6"> Nguyen,Gia Huy (Tony)</a> </td><td>2</td><td class="result">½ - ½</td><td>0.5</td><td class="name"><span class="idblack">5 </span><span class="notitle male"> </span> <a href="playercard.php#5"> Lacson,Joemar</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
<tr> <td>2</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 1 </span><span class="notitle male"> </span> <a href="playercard.php#1"> Paul,Cijo</a> </td><td>1</td><td class="result">0 - 1</td><td>2</td><td class="name"><span class="idblack">4 </span><span class="notitle male"> </span> <a href="playercard.php#4"> Hogg,Dean</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
<tr> <td>3</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 2 </span><span class="notitle male"> </span> <a href="playercard.php#2"> Annapureddy,Rheyansh Reddy</a> </td><td>3</td><td class="result">1 - 0</td><td>0.5</td><td class="name"><span class="idblack">3 </span><span class="title male"> CM</span> <a href="playercard.php#3"> Davis,Tony J</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
</tbody>
</table>
</DIV><hr>
		  </div>
