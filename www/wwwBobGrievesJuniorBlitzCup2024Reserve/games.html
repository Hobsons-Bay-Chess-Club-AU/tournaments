...
<input type="hidden" id="gamename" value="Bob Grieves Junior Blitz Cup 2024 Reserve">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/Bob Grieves Junior Blitz Cup 2024 Reserve12.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
