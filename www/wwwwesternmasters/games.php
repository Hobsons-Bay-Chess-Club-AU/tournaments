...
<input type="hidden" id="gamename" value="western masters">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/western masters2.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
