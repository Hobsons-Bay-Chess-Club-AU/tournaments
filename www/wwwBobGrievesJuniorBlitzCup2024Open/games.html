...
<input type="hidden" id="gamename" value="Bob Grieves Junior Blitz Cup 2024 Open">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/Bob Grieves Junior Blitz Cup 2024 Open14.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
