...
<input type="hidden" id="gamename" value="western juniors">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/western juniors2.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
