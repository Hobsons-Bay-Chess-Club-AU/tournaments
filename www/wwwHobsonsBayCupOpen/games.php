...
<input type="hidden" id="gamename" value="Hobsons Bay Cup Open">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/Hobsons Bay Cup Open6.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
