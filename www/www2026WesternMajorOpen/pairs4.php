...
<tr> <td>2</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 1 </span><span class="notitle male"> </span> <a href="playercard.php#1"> Bodke,Krishna Manthan</a> </td><td>2</td><td class="result"> adj </td><td>2</td><td class="name"><span class="idblack">4 </span><span class="notitle male"> </span> <a href="playercard.php#4"> Whitford,Matthew</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
<tr> <td>3</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 2 </span><span class="notitle male"> </span> <a href="playercard.php#2"> Hill,James</a> </td><td>3</td><td class="result"> adj </td><td>1</td><td class="name"><span class="idblack">3 </span><span class="notitle male"> </span> <a href="playercard.php#3"> Ruaya,Chris Rodson</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
</tbody>
</table>
</DIV><hr>
		  </div>
