...
<input type="hidden" id="gamename" value="2025 HBCC Honourable Bob Juniors">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2025 HBCC Honourable Bob Juniors5.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
