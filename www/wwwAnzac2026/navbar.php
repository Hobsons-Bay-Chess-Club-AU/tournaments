...
<title>2026 ANZAC Day Inter Club Championship</title>
 ...
 <section id="hero" class="d-flex align-items-center" style="background-image: url('../oweb/sfondo-chess2.webp')">
                <div class="container-fluid">
                    <div class="row items-center">
                        <div class="col-12">
                            <div class="flex flex-column justify-content-center text-center text-white">			<h1 class="mb-3" style="text-shadow: 2px 2px 4px #000000;" >2026 ANZAC Day Inter Club Championship</h1>		    <h5 class="mb-1">Hybrid (MAS, NZL, AUS) (AUS)</h5>		    <h5> 25/04/2026 - 25/04/2026</h5>   </div>
 </div> 
 </div>
 </div> 
 </section>
