 ...
 <section id="hero" class="d-flex align-items-center">
                <div class="container-fluid">
                    <div class="row items-center">
                        <div class="col-12">
                            <div class="flex flex-column justify-content-center text-center text-white">			<h1 class="mb-3" style="text-shadow: 2px 2px 4px #000000;" >2025 Hobsons Bay Western Major</h1>		    <h5 class="mb-1">Hobsons Bay (AUS)</h5>		    <h5> 29/04/2025 - 03/06/2025</h5>   </div>
 </div> 
 </div>
 </div> 
 </section>
...
<tr> 
<td><span class="idn"> 1</span></td><td> <span class="notitle male"> </span> <a href="http://ratings.fide.com/card.phtml?event=3201414" target="X"> Hogan,Steven </a></td><td ><img class="shadow" src="flag/vic.png" alt="VIC"></td><td>1515</td><td>0</td><td>1515</td> </tr>
</tbody>
