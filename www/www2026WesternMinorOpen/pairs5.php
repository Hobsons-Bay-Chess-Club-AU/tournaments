...
<tr> <td>2</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 4 </span><span class="notitle male"> </span> <a href="playercard.php#4"> Nowak,Ruben</a> </td><td>1</td><td class="result"> adj </td><td>3</td><td class="name"><span class="idblack">2 </span><span class="title female"> WIM</span> <a href="playercard.php#2"> Szuveges,Narelle S</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
<tr> <td>3</td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td><td class="name"> <span class="idwhite"> 5 </span><span class="notitle male"> </span> <a href="playercard.php#5"> Mullen,Chris</a> </td><td>2</td><td class="result"> adj </td><td>1.5</td><td class="name"><span class="idblack">1 </span><span class="notitle male"> </span> <a href="playercard.php#1"> Matijas,Dejan</a></td><td><img class="shadow" src="flag/vic.png" alt="VIC"></td></tr>
</tbody>
</table>
</DIV><hr>
		  </div>
