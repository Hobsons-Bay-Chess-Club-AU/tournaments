...
<input type="hidden" id="gamename" value="2026 Western Minor Open">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2026 Western Minor Open5.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
